...
class ProductToMeasure(BaseModel):
    """
    ProductToMeasure
    """
    ...
    __properties = ["amount", "created_at", "gtin", "id", "is_converted", "is_primary_measure", "raw_amount", "unit_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductToMeasure:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductToMeasure:
        """Create an instance of ProductToMeasure from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductToMeasure.parse_obj(obj)

        _obj = ProductToMeasure.parse_obj({
