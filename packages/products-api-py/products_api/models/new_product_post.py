...
class NewProductPost(BaseModel):
    """
    NewProductPost
    """
    ...
    measures: NewProductToMeasurePost = Field(...)
    __properties = ["gtin", "productname", "sku", "measures"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NewProductPost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NewProductPost:
        """Create an instance of NewProductPost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NewProductPost.parse_obj(obj)

        _obj = NewProductPost.parse_obj({
            "gtin": obj.get("gtin"),
            "productname": obj.get("productname"),
            "sku": obj.get("sku"),
            "measures": NewProductToMeasurePost.from_dict(obj.get("measures")) if obj.get("measures") is not None else None
        })
        return _obj
