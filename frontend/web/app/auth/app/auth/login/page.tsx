...
import { TextInput, PasswordInput, Checkbox, Button, Paper, Title, Container, Text } from "@mantine/core"
...
export default function LoginPage() {
  ...
  const handleSubmit = async (values: typeof form.values) => {
    try {
      ...
      const response = await fetch("http://localhost:8081/api/login/v1", {
        method: "POST",
        headers: {
    ...
    <Container size={420} my={40}>
      ...
      <Paper withBorder shadow="md" p={30} mt={30} radius="md">
        <form onSubmit={form.onSubmit(handleSubmit)}>
          ...
          <Checkbox label="Remember me" mt="md" {...form.getInputProps("rememberMe", { type: "checkbox" })} />
